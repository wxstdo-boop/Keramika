...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  void _removePin() async {
    ...
    if (confirm == true) {
      // Плавно стираем ПИН: снимаем FLAG_SECURE через несколько миллисекунд,
      // чтобы переключатель задач сразу показывал реальный контент (без
      // замораживания размытой заглушки), затем сверяем флаг.
